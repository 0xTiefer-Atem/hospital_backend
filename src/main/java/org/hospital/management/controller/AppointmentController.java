...
import org.hospital.management.mapper.AppointmentMapper;
...
public class AppointmentController {
    ...
    public ResponseV2 appointmentListInit(@RequestBody Map paraMap) {
        ...
        try {
            List<AppointmentPojo> appointmentList = appointmentMapper.appointmentListInit(staffId, startTime, endTime);
    ...
    public ResponseV2 searchByAppointmentId(@RequestBody Map paraMap) {
        ...
        List<AppointmentPojo> appointmentPojoList = appointmentMapper.searchAppointmentById(appointmentId);
